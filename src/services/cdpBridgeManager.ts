...
export interface CdpBridge {
    ...
    botApi: Api | null;
    // SECURITY: botToken removed from bridge — pass as function parameter where needed.
    // Storing tokens on long-lived objects increases leak surface if serialized/logged.
}
